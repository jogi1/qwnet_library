...
#include "quakedef.h" /* for struct frame_s :/ */
...
void NetQW_CopyFrames(struct NetQW *netqw, struct frame_s *frames, unsigned int *newseqnr, unsigned int *startframe, unsigned int *endframe);
